...
var myLIs = document.querySelectorAll('ul > li > ul > li');
...
var ThirdCol = document.querySelectorAll('table > tbody > tr > td:nth-child(3n-3)');

for (i = 0; i<ThirdCol.length; i++){
	ThirdCol[i].classList.add('special');
	};
